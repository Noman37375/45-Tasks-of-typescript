...
//method 1
let Favourit_Transport:string[] = ["Green line ","Motor cycle","Car","w-11"];
...
// Favourit_Transport.forEach((Favourit_Transport)=> {
//     console.log(`I would like to own a ${Favourit_Transport}.`);
// });